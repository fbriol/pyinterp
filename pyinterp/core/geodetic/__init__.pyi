...
_BaseModel = TypeVar("_BaseModel", Point, LineString, Polygon)
...
class MultiPoint:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, points: collections.abc.Sequence[Point] = ...) -> None: ...
...
class MultiPolygon:
    ...
    def __init__(self) -> None: ...
    @overload
    def __init__(self, polygons: collections.abc.Sequence[Polygon] = ...) -> None: ...
...
class _BaseModelView(Generic[_BaseModel]):
    def append(self, item: _BaseModel) -> None: ...
    def clear(self) -> None: ...
    def __getitem__(self, index: int) -> _BaseModel: ...
    def __iter__(self) -> Iterator[_BaseModel]: ...
    def __len__(self) -> int: ...
    def __setitem__(self, index: int, item: _BaseModel) -> None: ...
