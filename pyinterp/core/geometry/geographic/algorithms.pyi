...
@overload
def covered_by(geometry1: MultiLineString, geometry2: MultiPolygon) -> bool: ...
@overload
...
@overload
def crosses(geometry1: MultiLineString, geometry2: MultiLineString) -> bool: ...
@overload
...
@overload
def relate(geometry1: LineString, geometry2: LineString, mask: str) -> bool: ...
@overload
...
@overload
def touches(geometry1: MultiLineString, geometry2: MultiLineString) -> bool: ...
@overload
