...
auto init_spheroid(nanobind::module_ &m) -> void {
  auto spheroid = nb::class_<geodetic::Spheroid>(m, "Spheroid", kSpheroidDoc);
  ...
  spheroid
      ...
      .def_prop_ro(
          "semi_major_axis",
          [](const geodetic::Spheroid &self) { return self.semi_major_axis(); },
          "Semi-major axis of ellipsoid, in meters (:math:`a`).",
          nb::call_guard<nb::gil_scoped_release>())

      .def_prop_ro(
          "flattening",
          [](const geodetic::Spheroid &self) { return self.flattening(); },
          "Flattening of ellipsoid (:math:`f=\\frac{a-b}{a}`).",
          nb::call_guard<nb::gil_scoped_release>())

      .def(
          "semi_minor_axis",
          [](const geodetic::Spheroid &self) { return self.semi_minor_axis(); },
          kSemiMinorAxisDoc, nb::call_guard<nb::gil_scoped_release>())

      .def(
          "first_eccentricity_squared",
          [](const geodetic::Spheroid &self) {
      ...
      .def(
          ...
          [](const geodetic::Spheroid &self, const bool semi_major_axis) {
      ...
      .def(
          "axis_ratio",
          [](const geodetic::Spheroid &self) { return self.axis_ratio(); },
      ...
      .def(
          "mean_radius",
          [](const geodetic::Spheroid &self) { return self.mean_radius(); },
          kMeanRadiusDoc, nb::call_guard<nb::gil_scoped_release>())

      .def(
          "geocentric_radius",
          [](const geodetic::Spheroid &self, const double lat) {
      ...
      .def(
          "authalic_radius",
          [](const geodetic::Spheroid &self) { return self.authalic_radius(); },
      ...
      .def(
          "__eq__",
          [](const geodetic::Spheroid &self, const geodetic::Spheroid &other) {
            return self == other;
          },
          nb::arg("other"),
      ...
      .def(
          "__setstate__",
          [](geodetic::Spheroid &self, nb::tuple &state) {
            if (state.size() != 2) {
              throw std::invalid_argument("Invalid state");
            }
            auto semi_major_axis = nb::cast<double>(state[0]);
            auto flattening = nb::cast<double>(state[1]);
            return new (&self) geodetic::Spheroid(semi_major_axis, flattening);
          },
